        ...
        return Stack(children: [
          SafeArea(
            child: Column(children: [
              ...
              Text('${st.shadedCount} CELLS SHADED',
                  style: techno(10.5, color: kTextDim, letterSpacing: 1.4)),
              Expanded(child: Center(child: _board(st))),
              Text('''TAP: SHADE → CIRCLE → CLEAR · NO REPEATS, SHADES DON'T TOUCH''',
                  style: techno(8.5, color: kTextDim, letterSpacing: 1)),
  ...
  Widget _board(GameState st) {
    ...
    return Container(
      ...
      child: GestureDetector(
        onTapUp: (d) {
          final c = (d.localPosition.dx / cell).floor() - (0);
          final r = (d.localPosition.dy / cell).floor() - (0);
          if (r < 0 || c < 0 || r >= st.n || c >= st.n) return;
          if (Preferences.instance.isVibrationEnabled()) {
            ...
            child: Container(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                Container(
                  ...
                  child: const Icon(Icons.grid_4x4_rounded, color: kAccent, size: 28),
                ),
